...
public class imageDAO extends DAO{
	...
	public int insertProductImage(imageDetailDTO iddto) {
		int result=0;
		int result1=0;
		String sql = "insert into image values((select max(img_no)+1 from image i),'I02',(select max(pdt_no) from product p))";
	...
	public int insertShopImage(imageDetailDTO iddto, String smid) {
		int result=0;
		int result1=0;
		String sql = "insert into image values((select max(img_no)+1 from image i),'I01',?)";
		String sql1= "insert into image_detail values((select max(img_no)+1 from image_detail d),?,sysdate(),?,'Y')";
